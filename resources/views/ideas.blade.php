	...
	<div class="bg-gray-900 py-24 sm:py-32">
		<div class="mx-auto max-w-7xl px-6 lg:px-8">
			<div class="mx-auto max-w-2xl lg:mx-0">
				...
				<a href="/ideas?status=pending" class="btn">Pending  {{$statusCounts->get('pending')}}</a>
				<a href="/ideas?status=completed" class=" btn">Completed {{$statusCounts->get('completed')}}</a>
				<a href="/ideas?status=in_progress" class=" btn">In Progress{{$statusCounts->get('in_progress')}}</a>
			</div>
